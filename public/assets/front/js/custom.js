...
$(function ($) {
  ...
  $(document).ready(function () {
    ...
    //  AGE FORM SUBMIT SECTION

    $(document).on("submit", "#ageform", function (e) {
      e.preventDefault();
      $("#sub-btn").prop("disabled", true);
      var age = $("#ageform").find("input[name=age]").val();
      age = parseInt(age);
      if (age < 21) {
        $("#sub-btn").prop("disabled", false);
        ...
        $("#agecheckerForm")
          .find("h1")
          .text("Sorry, you must be 21 to enter this site");

        $("#agecheckerForm .social-links").removeClass("d-none");
    ...
    $(document).on("submit", "#verifiedform", function (e) {
      e.preventDefault();
      $(".gocover").show();
      $("button.submit-btn").prop("disabled", true);
      $.ajax({
    ...
    function getSizePrice() {
      ...
      if ($(".product-size .siz-list li").length > 0) {
        total = parseFloat(
          $(".product-size .siz-list li.active").find(".size_price").val()
        );
      }
...
function showDesktopSearchField(obj) {
  ...
  if ($(".desktop-search-field .search-field").css("display") == "flex") {
    ...
    $(".desktop-search-field .search-table").css("display", "none");
  } else {
    $(".desktop-search-field .search-field").css("display", "flex");
    $(".desktop-search-field .search-table").css("display", "block");
...
function totalSearch(event, type) {
  var search_word = $(
    "." + type + "-search-field .search-field .search-input"
  ).val();
  ...
  if (event.keyCode == 13 || event.keyCode == 1200) {
    window.location.href =
      "http://" + window.location.host + "/search/" + key + "/" + search_word;
    return;
  }
  ...
  timer = setTimeout(function () {
    $.ajax({
      ...
      beforeSend: function () {
        ...
        $(".search-dropdown").html("<div align='center'>loading data...</div>");
      },
      success: function (data) {
        if (data.length != 0) {
          var html = "";
          ...
          for (var k = 0; k < data.length; k++) {
            ...
            html += "<a href='/collections/" + category_slug + "/products/" + product_slug + "'>";
            if (scr > 768) {
...
function searchSelTableGroup() {
  $(".search-dropdown").css("display", "none");
  if ($(".search-table .dropdown").css("display") == "block") {
    $(".search-table .dropdown").css("display", "none");
  } else {
    $(".search-table .dropdown").css("display", "block");
  }
}
function selSearchTableItem(name) {
